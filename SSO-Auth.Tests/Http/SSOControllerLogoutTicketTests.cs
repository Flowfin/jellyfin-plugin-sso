...
public class SSOControllerLogoutTicketTests
{
    ...
    {
        // This is the only route on the controller reachable with no credential that ends a session, and
        // every other logout refusal beside it records a fixed reason code. A ticket-guessing flood that
