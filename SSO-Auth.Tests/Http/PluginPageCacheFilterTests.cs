...
public class PluginPageCacheFilterTests
{
    ...
    public void APageListThatThrows_LeavesTheHostsResponseAsBuilt_AndWarns()
    {
        ...
        Assert.Contains("stands as it was", entry.Message, StringComparison.Ordinal);
    }
    ...
    public void TheHostResolvesTheFilter_FromWhatTheRegistratorRegistered()
    {
        ...
        Assert.Single(filters, f => f is ServiceFilterAttribute service && service.ServiceType == typeof(PluginPageCacheFilter));
