...
/// <summary>
/// The tag the embedded assets carry (#1707), pinned independently of the route that serves them: it is a
/// digest of the build of the assembly that is serving, not a version field every build of this line
/// shares.
/// </summary>
public class PluginAssetVersionTests
{
    ...
    {
        // The defect of #1707: the project pins the file version at the line's three-part number and the
    ...
    public void AnAssemblyWithNoLocation_FallsBackToItsVersion_RatherThanNoTag()
    {
        ...
        // failed type initializer that would take the asset route down.
