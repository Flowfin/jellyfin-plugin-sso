// The controller of the Server page (#1527): the server-wide switches and the configuration transfer pair.
//
 ...
 */
export default function initSsoServerPage(view) {
  ...
  try {
    import(ApiClient.getUrl("web/ConfigurationPage", { name: SSO_CORE_PAGE }))
      .then((core) => core.pageControllers.server(view))
