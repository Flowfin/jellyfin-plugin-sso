// The controller of the Policies page (#1527): the named provisioning-profile editor.
//
 ...
 */
export default function initSsoPoliciesPage(view) {
  ...
  try {
    import(ApiClient.getUrl("web/ConfigurationPage", { name: SSO_CORE_PAGE }))
      .then((core) => core.pageControllers.policies(view))
